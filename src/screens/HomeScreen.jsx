...
import { MENU, startPrice } from '../data/menu';
    ...
    <section style={{ padding: '24px 28px 40px', textAlign: 'center' }}>
      ...
      <Reveal delay={1300} style={{ marginTop: 36 }}>
        <div style={{
          ...
          <ImageSwap a="/photo-waffle.png" b="/photo-bowl.png" />
        </div>
      </Reveal>
    </section>
  );
...
function BuiltForPeople() {
  return (
    <section style={{ background: BRAND.cream, padding: '56px 28px 40px' }}>
      <Reveal>
        <h2 style={{
          margin: '0 0 22px',
          fontFamily: 'Instrument Serif, serif', fontStyle: 'italic',
      ...
      <Reveal delay={220}>
        <div style={{
          ...
          <img src="/photo-bowl.png" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
      </Reveal>
    </section>
  );
  ...
  return (
    <div onClick={onOpen} style={{
      ...
      <div style={{ padding: '14px 16px 18px' }}>
        ...
        <div style={{ marginTop: 10, fontFamily: 'DM Sans, sans-serif', fontSize: 14, color: BRAND.forest, letterSpacing: '-0.02em' }}>
          ₹{startPrice(m)}
        </div>
      </div>
    </div>
...
function MenuCTA({ goto }) {
  return (
    <section style={{
      margin: '24px 24px 32px', borderRadius: 24, padding: '36px 28px',
      ...
      <div style={{ position: 'relative', minHeight: 180 }}>
        {quotes.map((q, idx) => (
          <div key={idx} style={{
            ...
            <div style={{ marginTop: 18, fontSize: 12, color: BRAND.inkSoft, letterSpacing: '-0.02em' }}>{q.a}</div>
          </div>
        ))}
      </div>
...
function FooterSection() {
  return (
    <footer style={{ background: BRAND.forestDeep, color: BRAND.cream, padding: '48px 28px 100px' }}>
      <div style={{
        fontFamily: 'Instrument Serif, serif', fontStyle: 'italic',
        fontSize: 36, lineHeight: 0.95, letterSpacing: '-0.02em', marginBottom: 30,
      }}>tbs<br />kitchen.</div>
